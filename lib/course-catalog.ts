...
export const COURSE_CATALOG: readonly CourseCatalogItem[] = [
  ...
  {
    id: 'assessment',
    title: 'Assessment for Learning at AISG',
    description: 'Use clear learning intentions, purposeful evidence, actionable feedback and learner self-assessment to make assessment part of the learning process.',
    intro: 'Assessment for Learning is not a collection of extra quizzes. It is the deliberate use of evidence while learning is still happening so teachers and learners can decide what to do next. This short course connects AISG’s expectations for formative assessment and timely feedback with the Transformative Learning Framework, especially Agency and Personalisation. You will work with learning intentions, success criteria, checks for understanding, feedback, self-assessment and peer learning—always asking whether the evidence is helping more learners improve.',
    category: 'Learning & Teaching',
    designation: 'Recommended',
    duration: '25–30 minutes',
    sectionCount: 5,
    checkCount: 12,
    storageKey: 'my-courses-assessment-for-learning-progress-v1',
    capabilities: ['Formative assessment', 'Success criteria & evidence', 'Actionable feedback', 'Learner agency & self-assessment'],
  },
  {
    id: 'data',
