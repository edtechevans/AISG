...
export const aiSections: AiSection[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'ai-10', section: 'purposeful-thinking', scenario: 'You find an impressive feature that can generate personalised practice instantly. It would require student accounts and could complete much of the reasoning your unit is designed to develop.', question: 'Which professional decision should come first?', options: [{ id: 'a', text: 'Adopt it if it saves enough teacher preparation time.' }, { id: 'b', text: 'Use it in every class so students have an equal experience.' }, { id: 'c', text: 'Clarify the learning problem and student thinking to preserve, then evaluate whether the educational benefit justifies the data and account implications.' }, { id: 'd', text: 'Ask students whether they would enjoy it and let that decide.' }], answer: 'c', correctFeedback: 'Correct. Start with the learner, learning goal and thinking that must remain visible. Then decide whether the educational benefit justifies the privacy, account and implementation implications.', incorrectFeedback: 'Purpose comes before novelty or efficiency. A sound decision weighs the learning goal and student agency alongside the tool’s data and account implications.' },
    ],
  },
];
